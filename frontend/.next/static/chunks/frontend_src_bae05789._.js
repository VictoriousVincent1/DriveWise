...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        try {
            ...
            try {
                ...
                const { db } = await __turbopack_context__.A("[project]/frontend/src/lib/firebase.ts [app-client] (ecmascript, async loader)");
                const snap = await getDoc(doc(db, "users", userCred.user.uid));
                console.log("Profile data:", snap.exists() ? snap.data() : "No profile found");
                if (snap.exists() && ((_snap_data = snap.data()) === null || _snap_data === void 0 ? void 0 : _snap_data.profileCompleted)) {
    ...
    const handleGoogle = async ()=>{
        ...
        try {
            var _snap_data;
            const userCred = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signInWithPopup"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$lib$2f$firebase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["auth"], new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$firebase$2f$node_modules$2f40$firebase$2f$auth$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GoogleAuthProvider"]());
...
//# sourceMappingURL=frontend_src_bae05789._.js.map