...
function CarQuiz() {
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CarQuiz.useMemo[filtered]": ()=>{
            ...
            if (body) {
                if (body.includes('Sedan')) list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>v.category === 'sedan'
                }["CarQuiz.useMemo[filtered]"]);
                else if (body.includes('SUV')) list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>v.category === 'suv'
                }["CarQuiz.useMemo[filtered]"]);
                else if (body.includes('Truck')) list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>v.category === 'truck'
                }["CarQuiz.useMemo[filtered]"]);
                else if (body.includes('Minivan')) list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>v.category === 'minivan'
                }["CarQuiz.useMemo[filtered]"]);
            }
            if (party === '6+' || cargo === 'Yes, lots of space') {
                list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>[
                            'suv',
                            'minivan',
                            'truck'
                        ].includes(v.category)
            ...
            if (efficiency === 'Very important') {
                list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>v.fuelEconomy.city >= 30 || v.features.some({
                            "CarQuiz.useMemo[filtered]": (f)=>f.toLowerCase().includes('hybrid')
                        }["CarQuiz.useMemo[filtered]"])
                }["CarQuiz.useMemo[filtered]"]);
            }
            if (powertrain === 'Yes') {
                list = list.filter({
                    "CarQuiz.useMemo[filtered]": (v)=>v.features.some({
                            "CarQuiz.useMemo[filtered]": (f)=>f.toLowerCase().includes('hybrid')
                        }["CarQuiz.useMemo[filtered]"])
                }["CarQuiz.useMemo[filtered]"]);
            }
...
//# sourceMappingURL=frontend_src_a9f85c57._.js.map